...
/**
 *	Gives different reference values for different distances
 *
 *	@param index Index to retrieve data for. Negative index means starting from the end
 *	@param sensor_id Sensor to get ID for
 *
 *	@return AD reference value for given sensor
 */
...
/**
 *	Convert AD values for given sensor to distance
 *
 *	@param ad_in AD value for distance sensor
 *	@param sensor_id Sensor ID for sensor to convert value for
 *
 *	@return Distance from sensor edge in mm to target. Range is between 50-300 mm
 */
